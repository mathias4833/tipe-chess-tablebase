  ...
  if chessboard.iswhite then
    ...
    if chessboard.wcastle then
      ...
      let castling_moves =
        ...
        if
          ...
          && Check.is_legal_move chessboard (Board.Chessmove (K, 4, 4))
          && Check.is_legal_move chessboard (Board.Chessmove (K, 4, 5))
          && Check.is_legal_move chessboard (Board.Chessmove (K, 4, 6))
      ...
      if
        ...
        && Check.is_legal_move chessboard (Board.Chessmove (K, 4, 4))
        && Check.is_legal_move chessboard (Board.Chessmove (K, 4, 3))
        && Check.is_legal_move chessboard (Board.Chessmove (K, 4, 2))
    ...
    let castling_moves =
      ...
      if
        ...
        && Check.is_legal_move chessboard (Board.Chessmove (K, 60, 60))
        && Check.is_legal_move chessboard (Board.Chessmove (K, 60, 61))
        && Check.is_legal_move chessboard (Board.Chessmove (K, 60, 62))
      then [ Board.ShortCastling ]
      else []
    in
    (* Grand roque *)
    if
      ...
      && Check.is_legal_move chessboard (Board.Chessmove (K, 60, 60))
      && Check.is_legal_move chessboard (Board.Chessmove (K, 60, 59))
      && Check.is_legal_move chessboard (Board.Chessmove (K, 60, 58))
    then Board.LongCastling :: castling_moves
    else castling_moves
  else [] (* Le roi a deja joue, pas de roque possible *)
